...
At any given time there are three revisions of the MongoDB charm [available on CharmHub.io](https://charmhub.io/mongodb-k8s), for each of the following channels:
...
Currently, the MongoDB charm does not make use of the `latest/beta` channel.
