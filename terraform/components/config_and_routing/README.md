...
| `mongos`        | git::https://github.com/canonical/mongos-k8s-operator//terraform?ref=6/edge | n/a     |
...
| `mongos`        | Configuration for mongos     | <pre>object({<br/> app_name = optional(string, "mongos")<br/> base = optional(string, "ubuntu@22.04")<br/> channel = optional(string, "6/stable")<br/> config = optional(map(string), {})<br/> constraints = optional(string, "arch=amd64")<br/> model_uuid = string<br/> revision = optional(number, null)<br/> units = optional(number, 3)<br/> })</pre>                                                                                                                                                                                                             | n/a     | yes      |
