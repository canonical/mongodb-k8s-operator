...
| <a name="input_mongos_k8s"></a> [mongos\_k8s](#input\_mongos\_k8s) | Configuration for mongos | <pre>object({<br/>    app_name = optional(string, "mongos-k8s")<br/>    model    = string<br/>    config   = optional(map(string), {})<br/>    channel  = optional(string, "8-transition/edge")<br/>    base     = optional(string, "ubuntu@24.04")<br/>    revision = optional(string, null)<br/>  })</pre> | n/a | yes |
